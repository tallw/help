...
<center><h4>INTERVENÇÕES EM ESCOLAS ESTADUAIS NA PARAÍBA</h4></center><br><br><br>
<center><img src="'.$capa.'" width="500" height="400"></center><br><br><br>
<center><h4>OBJETIVO: '.$tipo.' de Infraestrutura de TI na "'.$nome_escola.'"</h4></center><br>
...
$html_form.='<div align="center"><font size="2"><b>"'.$nome_escola.'"</b></font></div>';
$html_form.='<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><center><h6>João Pessoa, '.$dia.$meses[intval($mes-1)].$ano.'</h6></center><div style="page-break-after: always"></div>';
...
$html_form.='<tr><td><br></td></tr>';
$html_form.='<tr><td style="text-align:left;"><h4 style="margin-bottom: 10px; padding: 10px;">1 - ORDEM SERVIÇO</h4></td></tr>
<tr><td style="text-align:left;"><h4 style="margin-bottom: 10px; padding: 10px;">2 - RELATÓRIO FOTOGRÁFICO</h4></td></tr>
<tr><td style="text-align:left;"><h4 style="margin-bottom: 10px; padding: 10px;">3 - PLANILHA DE CUSTOS (MATERIAL E MÃO DE OBRA)</h4></td></tr>
<tr><td style="text-align:left;"><h4 style="margin-bottom: 10px; padding: 10px;">4 - MAPA DE COTAÇÕES</h4></td></tr>
<tr><td style="text-align:left;"><h4 style="margin-bottom: 10px; padding: 10px;">5 - COTAÇÕES</h4></td></tr>
<tr><td style="text-align:left;"><h4 style="margin-bottom: 10px; padding: 10px;">6 - ESPECIFICAÇÃO TÉCNICA</h4></td></tr><div style="page-break-after: always"></div>';
// <tr><td style="text-align:left;"><h4 style="margin-bottom: 10px; padding: 10px;">6 - AUTORIZAÇÃO</h4></td></tr>
$html_form.="</table>";
...
$html_form.='<div align="center"><font size="3"><b>Ordem Serviço: '.$protocolo.'</b></font></div>';
...
$pasta = 'img/fotos_os/';
$arquivos = glob("$pasta{*.jpeg,*.jpg,*.png,*.gif,*.bmp}", GLOB_BRACE);
foreach($arquivos as $img){

  $html_form.='<center><img src="'.$img.'" width="80%" height="80%"></center><br><br><br>';
  $html_form.='<div style="page-break-after: always"></div>';
...
$html_form.='<header><center><img src="logo/topo.png" width="500" height="80"></center></header><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
$html_form.='<div align="center"><font size="4"><b>RELATÓRIO FOTOGRÁFICO</b></font></div>';
$html_form.='<div style="page-break-after: always"></div>';
...
$html_form.='<header><center><img src="logo/topo.png" width="500" height="80"></center></header><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
$html_form.='<div align="center"><font size="4"><b>MAPA DE COTAÇÕES</b></font></div>';
$html_form.='<div style="page-break-after: always"></div>';

// ###################################################################################################### mapa cotacoes

$pasta = 'img/fotos_mapa/';
$arquivos = glob("$pasta{*.jpeg,*.jpg,*.png,*.gif,*.bmp}", GLOB_BRACE);
foreach($arquivos as $img){
...
$html_form.='<header><center><img src="logo/topo.png" width="500" height="80"></center></header><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
$html_form.='<div align="center"><font size="4"><b>COTAÇÕES</b></font></div>';
$html_form.='<div style="page-break-after: always"></div>';

// ###################################################################################################### img_cot

$pasta = 'img/fotos_cotacao/';
$arquivos = glob("$pasta{*.jpeg,*.jpg,*.png,*.gif,*.bmp}", GLOB_BRACE);
foreach($arquivos as $img){
...
//$html_form.='<header><center><img src="logo/topo.png" width="500" height="80"></center></header><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
//$html_form.='<div align="center"><font size="4"><b>AUTORIZAÇÃO</b></font></div>';
//$html_form.='<div style="page-break-after: always"></div>';

// ###################################################################################################### img_cot

//$html_form.='<header><center><img src="logo/topo.png" width="500" height="80"></center></header>';
//$html_form.='<center><img src="'.$img_aut.'" width="80%" height="80%"></center><br><br><br>';
//$html_form.='<div style="page-break-after: always"></div>';
