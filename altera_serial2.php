...
if(isset($usuario) && !is_numeric($usuario)){
    ...
    $query = "SELECT * FROM escola e, gre g WHERE e.id_escola = '$id_escola' AND e.gre = g.id_gre";
                            ...
                            <div class="card"">
                    			<div class="card-action">Informe o status para o Serial atual e escolha o Serial novo...</div>
                    				<div class="card-content">
    								    <form class="col s12" name="form-pesquisa" action="executions/grava_nova_bio2.php" method="post">
