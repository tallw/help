    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#mais").click(function() {
                ...
                var select_s = document.getElementById('sede');
                ...
                select_2_s.id = 'sede' + id_item;
                select_2_s.name = 'sede[]';
            ...
            <div id="page-wrapper">
              <div class="header"> 
                    <h1 class="page-header">
                        Cadastro de Insumos para Cotação
                    </h1>
                    <ol class="breadcrumb">
                        <li>Aqui você insere os insumos para cotação.</li>
                    </ol>                         
                </div>
                <div id="page-inner">               
                    <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-action" style="background: #1ebfae">
                             Dados da requisição de insumos:
                        </div> 
                        <div class="card-content">
                            
                            <form method="post" action="grava_insumos.php" name="cot_insumos">
                                ...
                                <div class="row" id="pai">
                                    <div class="input-field col s12" id="filho">
                                        <textarea style="width: 95%; height: 100px; margin-right: 20px" name="observacao" placeholder="Observações:" maxlength="10000" required=""></textarea>
                                        ...
                                        <div class="item_filho" id="item_filho"  style="display: flex;">
                                            ...
                                            <select name="item[]" class="form-control" id="item" style="width: 40%; margin-left: 20px; margin-bottom: 15px;">
                                                ...
                                                <?php //style="height: 2900px;"
                                                    ...
                                                    $query_itens = "SELECT * FROM insumos order by nome_insumo";
                                                    $result_itens = $link->query($query_itens);

                                                    while ($row_itens = mysqli_fetch_object($result_itens)) { ?>

                                                        <option value="<?php echo $row_itens->id_insumo; ?>"><?php echo $row_itens->nome_insumo; ?></option>
                                            ...
                                            <select name="sede[]" class="form-control" id="sede" style="width: 20%; margin-left: 20px; margin-bottom: 15px;">
                                                <option value="1">SEDE JP</option>
                                                <option value="2">SEDE CG</option>
                                                <option value="3">SEDE SS</option>
                                            </select>
