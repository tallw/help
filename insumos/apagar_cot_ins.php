    										...
    										if(!empty($_GET['id_cot'])){
    											...
    											if (!$link){
    											  ...
    											  die('Connect Error (' . mysqli_connecterrno() . ')' .
                                                    ...
                                                    $query_excluir_itens_cot_ins = "DELETE FROM `insumos_cotados` WHERE `fk_id_cot_insumo` = '$id_cot_ins'";
                                                    $result_excluir_itens_cot_ins = $link->query($query_excluir_itens_cot_ins) or die(  mysqli_error( $link ) );   // -----------> 2 = aprovada, 1 antigas, 0 

                                                    $query_excluir_cot_ins = "DELETE FROM `cotacoes_insumos` WHERE `id_cot_insumos` = '$id_cot_ins'";
                                                    $result_excluir_cot_ins = $link->query($query_excluir_cot_ins) or die(  mysqli_error( $link ) );   // -----------> 2 = aprovada, 1 

                                                    if ($result_excluir_cot_ins == TRUE) {
                                                        ...
                                                        //###################################################################################################################
    														...
    														<div class="input-field col s12">
    											                <div class="alert alert-success">
    											                    <strong>Cotação de Insumos Excluída com Sucesso!</strong><br>
    											                </div>
                                                            </div>
                                                            <div class="input-field col s3">
                                                                <a href="lista_insumos.php" class="waves-effect waves-light btn custom-back">Voltar</a>
                                                            </div>
    											            <?php
    														...
    														<div class="input-field col s12">
    											                <div class="alert alert-danger">
    											                    <strong>A Cotação não foi Excluída. Tente novamente.</strong>
    											                </div>            
    											            </div>
