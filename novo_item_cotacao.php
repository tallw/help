            ...
            <div id="page-wrapper">
              <div class="header"> 
                    <h1 class="page-header">
                        Inserção de novos Itens no levantamento de <small>Protocolo: <?php echo $protocolo; ?></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>Aqui você insere novos itens de levantamento.</li>
                    </ol>                         
                </div>
                <div id="page-inner">               
                    <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <form method="post" action="executions/grava_novos_itens_lev.php" name="lev_os">
