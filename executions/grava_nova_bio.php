     						...
     						<div class="table-responsive">
                                <?php
    								...
    								if(!empty($_POST)){
    									...
    									if(isset($_POST['id_os']) && isset($_POST['id_bio']) && isset($_POST['status_b']) && isset($_POST['nova_b'])){
    										...
    										if($_POST['status_b'] !== '0' && $_POST['nova_b'] !== '0'){
                                                ...
                                                $query = "SELECT * FROM ordem_servico WHERE id_os = '$id_os'";
                                                $result = $link->query($query) or die(mysqli_error($link));
                                                $row = mysqli_fetch_object($result);

                                                $id_escola = $row->fk_id_nome_escola;
    											...
    											if($mudou_bn == TRUE || $mudou_ba == TRUE){
    												...
    												<div class="input-field col s12">
    											        <div class="alert alert-success">
    											            <strong>Mudanças realizadas com sucesso!</strong>
    											        </div>
                                                    </div>
