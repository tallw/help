    											...
    											if (!$link){
    											  ...
    											  die('Connect Error (' . mysqli_connecterrno() . ')' .
    												...
    												if($result_update_os == TRUE){
                                                        ...
                                                        $query_update_cotacao = "UPDATE `cotacoes_os` SET `status_cotacao`= 2 WHERE `fk_id_os_cotada` = '$id_os'";
                                                        $result_update_cotacao = $link->query($query_update_cotacao) or die(  mysqli_error( $link ) );   // -----------> 2 = aprovada, 1 antigas, 0 nao aprovada
                                                        ...
                                                        $query_add_log = "INSERT INTO `log_acoes`(`id_acao`, `data_acao`, `descricao_acao`, `fk_id_user`) VALUES (NULL,'$DT_atual','Cotação aprovada na OS: $protocolo','$id_usersede')";
                                                        ...
                                                        //###################################################################################################################
    														...
    														<div class="input-field col s12">
    											                <div class="alert alert-success">
    											                    <strong>Cotação aprovada com Sucesso!</strong><br>
                                                                    <strong>Status da OS modificado para Em Execução...!</strong>
    											                </div>
                                                            </div>
