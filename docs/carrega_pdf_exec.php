...
$query_exec = "SELECT * FROM execucao_diaria WHERE id_execucao = '$id_exec'";
$result_exec = $link->query($query_exec);
$row_execs = mysqli_fetch_object($result_exec);

$tecnicos = $row_execs->tecnicos;
$local = $row_execs->local;
$servico = $row_execs->servico;
$observacao = $row_execs->observacao;
$pendencia = $row_execs->pendencias;

$dt_abertura = date_create( $row_execs->data_execucao);
$data_abertura = date_format($dt_abertura, 'd/m/Y H:i:s');

//######################### DADOS OS ###################################


$query_OS = "SELECT * FROM ordem_servico WHERE protocolo = '$protocolo'";
...
<col style="width: 133px">
  ...
  <tr>
    ...
    <td class="tg-center" colspan="1">'.$dt.'</td>
  ...
  <tr>
    <td class="tg-center" colspan="10">'.$local.'</td>
  </tr>
  <tr class="custom-line">
    <td class="tg-topic" colspan="10">SERVIÇO REALIZADO:</td>
  </tr>
  <tr>
    <td class="tg-line" colspan="10">'.$servico.'</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-line" colspan="10">'.$observacao.'</td>
  </tr>
  <tr>
    <td class="tg-line" colspan="10"></td>
  </tr>
  ...
  <tr>
    <td class="tg-line" colspan="10">'.$pendencia.'</td>
  </tr>
  <tr>
    <td class="tg-line" colspan="10"></td>
  </tr>
  ...
  <tr>
    <td class="tg-line" colspan="10">'.$tecnicos.'</td>
  </tr>
  <tr>
...
/* Exibe */
$dompdf->stream(
    "exec_".$dt."_".$protocolo.".pdf", /* Nome do arquivo de saída */
    array(
