 ...
 *
 * For details please refer to: http://www.datatables.net records 
 */
...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Sem dados disponíveis na tabela" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "Nenhum chamado para exibir",
	...
	$(document).ready(function() {
	    ...
	    $('#dataTables-example').dataTable({  //create table

	     //Campo ordenado por padrão (ao carregar página) O 1 é a coluna a ser ordenada lembrando que começa com 0
	        "order": [[2, "asc"]]   // use desc for descendente
	    });

	    $('#dataTables-meus-chamados').dataTable({  //create table

	     //Campo ordenado por padrão (ao carregar página) O 1 é a coluna a ser ordenada lembrando que começa com 0
	        "order": [[2, "desc"]]   // use desc for descendente
	    });
	});
