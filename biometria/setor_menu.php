                    ...
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="waves-effect waves-dark" href="../insumos/cad_insumos.php"><i class="material-icons left">assignment</i> Inserir</a>
                                </li>

                                <li>
                                    <a class="waves-effect waves-dark" href="../insumos/lista_insumos.php"><i class="material-icons left">assignment</i> Listar</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="waves-effect waves-dark" href="inserir_bio.php"><i class="material-icons left">assignment</i> Inserir</a>
                                </li>

                                <li>
                                    <a class="waves-effect waves-dark" href="bio_dashboard.php"><i class="material-icons left">assignment</i> Dashboard Bio</a>
                                </li>

                                <li>
                                    <a class="waves-effect waves-dark" href="gera_todas_bios.php"><i class="material-icons left">assignment</i> Rel Bios</a>
                                </li>

                                <li>
                                    <a class="waves-effect waves-dark" href="escola_bio.php"><i class="material-icons left">assignment</i> Rel Escolas Bio</a>
                                </li>
