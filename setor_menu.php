<div id="wrapper">
            <nav class="navbar navbar-default top-navbar" role="navigation">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand waves-effect waves-dark" href="#"><i class="large material-icons">perm_phone_msg</i> <strong><img height="45" width="193" src="image/logo_teste.png"></strong></a> <!-- <img height="45" width="193" src="image/help_logo.png"> -->
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    ...
                                    <ul class="nav nav-third-level">
                                        ...
                                        <li>
                                            <a href="setor_rel_mensal.php?tipo=1">Atividades por GRE (Gráfico)</a>
                                        </li>
                                        <li>
